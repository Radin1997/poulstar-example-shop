@extends('layouts.master', ['title' => 'تسویه حساب'])
        ...
        <form action="" method="" autocomplete="on">
            ...
            <div class="partition">
                <label>
                    ...
                    &nbsp; <a href="{{ route('pages.policies') }}">قوانین و مقررات</a> سایت را مطالعه کرده و با آگاهی کامل شرایط خرید آنلاین را می پذیرم. &nbsp;
                </label>
